package com.example.rainmusic.data.retrofit.weapi

import com.google.gson.JsonObject
import com.example.rainmusic.data.retrofit.weapi.model.*
...
/**
 * 网易云weapi接口
 * 访问此接口需要经过 [encryptWeAPI][com.example.rainmusic.util.encrypt.encryptWeAPI] 函数加密
 */
interface NeteaseMusicWeApi {
    ...
    @POST("/weapi/homepage/block/page")
    @FormUrlEncoded
    suspend fun getHomePageBlock(
        @FieldMap body: Map<String, String>
    ): HomePageBlock
